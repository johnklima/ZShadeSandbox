...
public:
	...
	static Mouse* GetMouse(HWND hwnd = NULL);
	...
	bool MouseOffscreen(int& dir, int w, int h, HWND hwnd);

    bool IsOverWindow;

private:
	
	static Mouse* prevState;
};
//===============================================================================================================================
#endif//__INPUT_H