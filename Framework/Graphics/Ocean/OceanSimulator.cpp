...
OceanSimulator::OceanSimulator(OceanParameters& params, ID3D11Device* pd3dDevice)
{
...
void OceanSimulator::initHeightMap(OceanParameters& params, XMFLOAT2* out_h0, float* out_omega)
{
	int i, j;
	XMFLOAT2 K, Kn;
...
const OceanParameters& OceanSimulator::getParameters()
{
	return m_param;
}
