...
void fft512x512_create_plan(CSFFT512x512_Plan* plan, ID3D11Device* pd3dDevice, UINT slices)
{
   ...
   pBlobCS = ZShadeSandboxShader::ShaderCompiler::GetShaderByName("Radix008A_CS")->mBlobData;
   pBlobCS2 = ZShadeSandboxShader::ShaderCompiler::GetShaderByName("Radix008A_CS2")->mBlobData;
