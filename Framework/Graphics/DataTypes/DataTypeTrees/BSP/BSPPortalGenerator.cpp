...
//==================================================================================================================================
void BSPPortalGenerator::DeletePortal(ZShadeSandboxBSP::BSPPortal* portal)
{
...
bool BSPPortalGenerator::CheckDuplicatePortal(ZShadeSandboxBSP::BSPPortal* portal, int& index)
{
	...
	for (long i = 0; i < arrayData->lNumberOfPortals; i++)
	{
		PALeaf1 = arrayData->portalArray[i]->LeafOwnerArray(0);
		PALeaf2 = arrayData->portalArray[i]->LeafOwnerArray(1);
		...
		if ((checkPortalLeaf1 == PALeaf1 && checkPortalLeaf2 == PALeaf2) || (checkPortalLeaf1 == PALeaf2 && checkPortalLeaf2 == PALeaf1))
		{
			...
			{
				ZShadeSandboxBSP::BSPPortal* temp = arrayData->portalArray[i];
	...
	index = arrayData->lNumberOfPortals;
