...
private:
	...
	static void SplitPortalPolygon(ZShadeSandboxBSP::BSPPortal* portal, ZShadeSandboxBSP::BSPPlane* plane, ZShadeSandboxBSP::BSPPortal* frontSplit, ZShadeSandboxBSP::BSPPortal* backSplit);
