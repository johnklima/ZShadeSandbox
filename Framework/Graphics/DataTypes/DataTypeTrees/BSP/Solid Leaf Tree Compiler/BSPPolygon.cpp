...
//==================================================================================================================================
void BSPPolygon::CreateMesh(D3D* d3d, ShaderMaterial* material)
{
	mMesh = new ZShadeSandboxMesh::PolygonMesh(d3d, material);
}
//==================================================================================================================================
...
{
	return GetVertexPosition(index, ZShadeSandboxMesh::EVertexType::Type::VT_Tex);
}
//==================================================================================================================================
ZShadeSandboxMath::XMMath2 BSPPolygon::GetVertexTexture(int index)
{
	return GetVertexTexture(index, ZShadeSandboxMesh::EVertexType::Type::VT_Tex);
}
//==================================================================================================================================
